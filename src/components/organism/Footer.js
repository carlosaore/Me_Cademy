...
const Footer = () => {
	return (
		<FooterDiv>
			...
			<Ul icon>
				<li href="https://www.facebook.com/dmitry.piskun.5" target="_blank">
					<i class="fab fa-facebook"></i>
				</li>
				<li href="https://www.instagram.com/dmitry_piskun/" target="_blank">
					<i className="fab fa-instagram" />
				</li>
				<li
					href="https://github.com/DzmitryPS/Currency_project"
					target="_blank"
				>
