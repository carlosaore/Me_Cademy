...
const NumbSteps = () => {
	return (
		<ComponentWrapper>
			<H2>
				Das erwartet dich in der „MeCademy – Erfolgreich bewerben als
				Akademikerin“
			</H2>
			<P alignCenter bold>
			...
			<P alignCenter>
				Was erwartet dich als Teilnehmerin und wie läuft die Anmeldung und das
				Programm ab? Diese 6 Schritte erklären es dir in aller Kürze:
			</P>
			<MainDiv>
				{textData.aboutNumeric.map((element, index) => (
					<NestedDiv key={uuidv4()}>
						<img src={element.image} alt="" />
						<P bold last hyphensAuto>
							{element.header}
						</P>
						<P last hyphensAuto>
							{element.text}
