    ...
    testimonialData: [
        {
            ...
            description: "Über das MentorMe-Netzwerk habe ich sowohl ein Praktium als auch meinen späteren Job bekommen. Meine beiden Mentorinnen waren tolle Frauen: zuerst eine Geschäftsführerin und dann eine Coach, die mich beide essentiell bei meinen beruflichen Fragen begleitet haben und mir stets Mit Rat und Expertise zur Seite standen.",
            urls: "/images/NadineSchultz.png"
        },
        {
            name: "Lucy Jo Fitz",
            title: "Projekt- und Eventmanagerin",
            description: "Ich habe inspirierende Menschen getroffen, konnte in verschiedenste Berufsfelder schnuppern und habe herausgefunden, welche Richtungen für mich interessant sind, da ich bei Veranstaltungen offene Fragen stellen konnte und ehrliche Antworten erhalten habe. Zudem konnte ich mein Selbstbewusstsein und auf mein Auftreten im beruflichen Kontext stärken.",
            urls: "/images/LucyJoFitz.png"
        },
        {
            name: "Marisa Kittel",
            title: "Europa Referentin",
            description: "MentorMe ist ein inspirierendes Netzwerk, das mir sehr viel Kraft und Sicherheit gab, um berufliche Herausforderungen zu meistern. Die Kombination aus Mentoring, Trainings und zahlreichen Netzwerk-Veranstaltungen ermöglichte mir sowohl über den beruflichen Tellerrand zu schauen, als auch eigene Karriere-Vorstellungen zu konkretisieren.",
            urls: "/images/MarisaKittel.png"
        },
        {
            name: "Nastya Koro",
            title: "User Experience Strategist",
            description: "Das Mentoring hat mir viel gebracht! Ich habe mich als Professional in der Umorientierungsphase mit meinem Mentor weiterentwickelt. Vom Bewerbungsprozess und Bewerbungsschreiben über Gehaltsverhandlungen bis hin zum Üben vor Jobinterviews. Auch vermittelte Kontakte haben sich positiv auf meine Jobsuche ausgewirkt.",
            urls: "/images/NastyaKoro.png"
        },
        {
            name: "Iuna Hoffmann",
            title: "Partnership Managerin",
            description: "Ich wurde Mentee bei MentorMe, weil ich aus einer Arbeiterfamilie komme und über keinerlei nützliche Kontakte in die Berufswelt verfügte. Darüber hinaus war das MentorMe-Programm eine sehr gute Gelegenheit, weiter an mir zu arbeiten und mich für meine zukünftigen Jobs besser aufzustellen. Ich kann MentorMe empfehlen und bin selbst ein zweites Jahr mit dabei.",
            urls: "/images/IunaHoffmann.png"
        },
        {   
            name: "Florence Mühlenbein",
            title: "Projektmanagerin",
            description: "MentorMe gab mir die Möglichkeit, mich beruflich vielfältig weiter zuentwickeln und spannende Arbeitgeber & Personen kennen zulernen. Dabei schätzte ich den Austausch im Netzwerk, mit den Expert*innen und meiner Mentorin, die mir immer neue Denkanstöße und Ideen für meine berufliche Karriere und meinen Weg geben.",
            urls: "/images/FlorenceMühlenbein.png"
        },
        {
            name: "Martje Schreier",
            title: "Regisseurin",
            description: "Ich bin glücklich, Teil von MentorMe geworden zu sein, weil ich hier viele tolle und inspirierende Menschen kennengelernt habe. Es ist ein Netzwerk voller grandioser Menschen, die mit ihrer Erfahrung und Expertise weiterhelfen, unterstützen und mir das Gefühl geben, meinen Weg nicht alleine gehen zu müssen.",
            urls: "/images/MartjeSchreier.png"
        },
        {
            name: "Maria Eckert",
            title: "E-Learning Expertin",
            description: "Ohne MentorMe, meine Mentoren und die Community wäre ich jetzt nicht da, wo ich stehe. Es hilft mir enorm, meine Ziele sichtbar zu machen, sie zu verfolgen und „on track“ zu bleiben. Es bedeutet für mich Verbindlichkeit, Zusammenhalt, Zugehörigkeit, Power, Motivation, Wegweiser und Inspiration!",
            urls: "/images/MariaEckert.png"
        },
        {
            name: "Stephanie Feser",
            title: "Strategiemanagerin",
            description: "MentorMe ist ein unglaublich vielfältiges Programm, sehr inspirierende und offene Menschen, innovative Angebote und ganz viel Herz(blut) in der Umsetzung. Ein herzliches Danke an Karin und ihr Team für diese Möglichkeiten! Ich kann jeder Frau nur raten, dabei zu sein!",
            urls: "/images/StephanieFeser.png"
        },
        {
            name: "Caya Prill",
            title: "Studentin",
